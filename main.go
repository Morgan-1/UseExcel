...
func main() {
	excelFileName := "统计单向航段信息.xlsx"
	lineTimes, lineAccounts, linePeoples, lineCountAge := readSingleExceFileData(excelFileName)
...
func readSingleExceFileData(excelFileName string) (lineTimes map[string]int64, lineAccounts map[string]int64,
